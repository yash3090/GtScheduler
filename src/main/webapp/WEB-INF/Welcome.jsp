...
<br>
<p> <h5> if waitlist/free spot is -1 then the algorithm can't check individual section's availability, due to the large number of sections for the course</h3>
